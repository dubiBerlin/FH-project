<?php
	...
	/**************************************************************************************************
	 *  																							  *
	 *	  Wird eine Geschichte aus dem DropDown-Menu ausgewählt um Positionen zu setzen bzw           *
	 *    zu löschen, wird scrollBuilders.php aufgerufen. um die Fenster dynamisch zu erstellen.      *
	 *    Es bekommt eine storyID von der aufrufenden JS-Datei (selectStory.js) übergeben und sucht   * 
	 *    danach die Geschichte aus.                                                                  *
...
{	
	...
	if(mysqli_error($verbindung)){
											...
											<tr>
												...
												<td>
													<input type="hidden" name="storyID" value='.$storyID.' />
  							   					...
  							   					<td>
													<Button name="saveButton"  id="saveButton" >Save position</Button>
												</td>
					       					</tr>
										</table>';
		...
		while($row = mysqli_fetch_assoc($abfrage)){
			...
			echo '	</table>';
			echo '</div>';	
//			echo	'<button type="button" class="navi_button"  id="save_to_db_button" styles="padding-top:10px">Save</button>';
